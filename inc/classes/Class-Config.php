...
final class Creative_Agency {
	...
	private function enqueue() {
		...
		$scripts = array(
			'style'   => array(
				array(
					'handler' => 'creativeagency-google-font',
				...
				array(
					'handler'    => 'creativeagency-owl-carousel-css',
					'file'       => $cssPath . 'owl.carousel.min.css',
					'dependency' => array(),
					'version'    => '1.0',
				),
				array(
					'handler'    => 'creativeagency-themify-icons',
					'file'       => $cssPath . 'themify-icons.css',
					'dependency' => array(),
					'version'    => '1.0',
				),
				array(
					'handler'    => 'creativeagency-nice-select-css',
					'file'       => $cssPath . 'nice-select.css',
					'dependency' => array(),
					'version'    => '1.0',
				),
				array(
					'handler'    => 'creativeagency-flaticon-css',
				...
				array(
					'handler'    => 'creativeagency-font-awesome',
					'file'       => $cssPath . 'font-awesome.min.css',
					'dependency' => array(),
					'version'    => '7.3.1-1',
				),
				array(
					'handler'    => 'creativeagency-slicknav-css',

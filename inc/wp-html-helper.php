...
// image default alt
if ( ! function_exists( 'creativeagency_img_default_alt' ) ) {
	function creativeagency_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'creativeagency_img_tag' ) ) {
	function creativeagency_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = creativeagency_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'creativeagency_anchor_tag' ) ) {
	function creativeagency_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'creativeagency_heading_tag' ) ) {
	function creativeagency_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'creativeagency_paragraph_tag' ) ) {
	function creativeagency_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'creativeagency_other_tag' ) ) {
	function creativeagency_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'creativeagency_button_element ' ) ) {
	function creativeagency_button_element( array $args ) {
